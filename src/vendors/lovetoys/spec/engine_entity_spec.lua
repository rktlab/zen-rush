...
describe(
  ...
  function()
    ...
    it(
      ":addEntity() sets self.rootEntity as parent",
      function()
        engine:addEntity(entity)
    ...
    it(
      ":addEntity() registers entity in self.rootEntity.children",
      function()
        engine:addEntity(entity)
    ...
    it(
      ":addEntity() adds entity to componentlist",
      function()
        entity:add(Component1())
        engine:addEntity(entity)
        assert.are.equal(
          engine:getEntitiesWithComponent("Component1")[1],
          entity
        )
      end
    )
    ...
    it(
      ":addEntity() adds entity to system, before system is added",
      function()
        entity:add(Component1())
        engine:addEntity(entity)
    ...
    it(
      ":addEntity() adds entity to system, after system is added",
      function()
        engine:addSystem(testSystem)
        entity:add(Component1())
        engine:addEntity(entity)
    ...
    it(
      ":add() adds entity to system, after Component is added to entity",
      function()
        engine:addEntity(entity)
        engine:addSystem(testSystem)
        entity:add(Component1())
    ...
    it(
      ":addEntity() adds entity to system, after Component is added to system",
      function()
        engine:addEntity(entity)
        engine:addSystem(testSystem)
        entity:add(Component1())
    ...
    it(
      ":getEntityCount() gets count of entities with Component, after Component is added to entities",
      function()
        entity:add(Component1())
    ...
    it(
      ":addEntity() handles multiple requirement lists",
      function()
        ...
        local Animal, Dog =
          lovetoys.Component.create("Animal"),
          lovetoys.Component.create("Dog")
    ...
    it(
      ":removeEntity() removes entity from Parent",
      function()
        engine:addEntity(entity)
        assert.are.equal(engine.rootEntity.children[1], entity)
        engine:removeEntity(entity)
    ...
    it(
      ":removeEntity() sets rootEntity as new parent/ registers as child",
      function()
        engine:addEntity(entity)
        entity2.parent = entity
        engine:addEntity(entity2)
    ...
    it(
      ":removeEntity() sets rootEntity as new parent",
      function()
        engine:addEntity(entity)
        entity2.parent = entity
        engine:addEntity(entity2)
    ...
    it(
      ":removeEntity() sets custom parent",
      function()
        engine:addEntity(entity)
        entity2.parent = entity
        engine:addEntity(entity2)
    ...
    it(
      ":removeEntity() removes from componentlist",
      function()
        entity:add(Component1())
        engine:addEntity(entity)
        assert.are.equal(
    ...
    it(
      ":removeEntity() removes from System",
      function()
        entity:add(Component1())
        engine:addEntity(entity)
        engine:addSystem(testSystem)
    ...
    it(
      ":removeEntity() unregistered entity from Engine",
      function()
    ...
    it(
      "Entity:remove() removes entity from single system target list, after removing component",
      function()
        entity:add(Component1())
        engine:addEntity(entity)
        engine:addSystem(testSystem)
    ...
    it(
      "Entity:remove() removes entity from system, after removing component",
      function()
        entity:add(Component1())
    ...
    it(
      "Entity:remove() removes entity from system with multiple requirements",
      function()
        entity:add(Component1())
        entity:add(Component2())
        engine:addEntity(entity)
