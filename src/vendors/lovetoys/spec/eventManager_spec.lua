  ...
  function()
    ...
    it(
      ...
      function()
        ...
        assert.are.equal(
          type(eventManager.eventListeners["TestEvent"]),
          "table"
        )
        assert.are.equal(
          eventManager.eventListeners["TestEvent"][1][1],
          listener
        )
      end
    )
    ...
    it(
      "addListener() doesn`t add Listener twice",
      function()
        eventManager:addListener("TestEvent", listener, listener.test)
        assert.are.equal(
          type(eventManager.eventListeners["TestEvent"]),
        ...
        assert.are.equal(
          eventManager.eventListeners["TestEvent"][1][1].number,
          0
        )
    ...
    it(
      "addListener() without function throws debug message",
      function()
    ...
    it(
      "addListener() without listener.class.name on listener throws debug message",
      function()
        -- Mock lovetoys debug function
        local debug_spy = spy.on(lovetoys, "debug")
    ...
    it(
      "removeListener() on unregistered listener throws debug message",
      function()
        -- Mock lovetoys debug function
        local debug_spy = spy.on(lovetoys, "debug")
    ...
    it(
      "fireEvent() listener Function is beeing called",
      function()
        eventManager:addListener("TestEvent", listener, listener.test)
        assert.are.equal(
          type(eventManager.eventListeners["TestEvent"]),
