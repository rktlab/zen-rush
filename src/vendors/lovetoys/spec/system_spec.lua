...
describe(
  ...
  function()
    ...
    it(
      ":addEntity() adds entities into different categories",
      function()
    ...
    it(
      ":pickRequiredComponents() returns the requested components",
      function()
        local addedComponent1 = lovetoys.class("Component1")()
        entity:add(addedComponent1)
        requireSystem:addEntity(entity)

        local returnedComponent1, nonExistentComponent =
          requireSystem:pickRequiredComponents(entity)
    ...
    it(
      ":pickRequiredComponents() throws debug message on multiple requirement systems",
      function()
        local addedComponent1 = lovetoys.class("Component1")()
        entity:add(addedComponent1)
        multiSystem:addEntity(entity)
    ...
    it(
      ":initialize() shouldnt allow mixed requirements in requires()",
      function()
        local IllDefinedSystem =
          lovetoys.class("IllDefinedSystem", lovetoys.System)
    ...
    it(
      ":removeEntity calls onRemoveEntity for system with requirement groups",
      function()
        ...
        assert.spy(cb_spy).was.called_with(
          multiSystem,
          entity,
          "ComponentType1"
        )
    ...
    it(
      ":removeEntity calls onRemoveEntity for system with no requirement groups",
      function()
        local Component1 = lovetoys.class("Component1")
        entity:add(Component1())
