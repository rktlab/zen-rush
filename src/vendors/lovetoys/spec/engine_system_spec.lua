...
describe(
  ...
  function()
      ...
      function()
        ...
        function UpdateSystem:update()
          for _, entity in pairs(self.targets) do
            entity:get("Component1").number =
              entity:get("Component1").number + 5
          end
        end
        ...
        function DrawSystem:draw()
          for _, entity in pairs(self.targets) do
            entity:get("Component1").number =
              entity:get("Component1").number + 10
          end
        end
    ...
    it(
      ":addSystem() adds System to systemRegistry",
      function()
        engine:addSystem(updateSystem)
        assert.are.equal(
          engine.systemRegistry[updateSystem.class.name],
          updateSystem
        )
      end
    )
    ...
    it(
      ":addSystem() doesn`t add same system type twice",
      function()
        engine:addSystem(updateSystem)
    ...
    it(
      ":addSystem() doesn`t add Systems with both, but does, if specified with type",
      function()
    ...
    it(
      ":addSystem() adds BothSystem to singleRequirements, if specified with type",
      function()
        engine:addSystem(bothSystem)
        assert.are_not.equal(
          type(engine.singleRequirements["Component1"]),
          "table"
        )
        assert.are_not.equal(
          type(engine.singleRequirements["Component2"]),
          "table"
        )
    ...
    it(
      ...
      function()
        engine:addSystem(bothSystem)
        assert.are_not.equal(
          type(engine.allRequirements["Component1"]),
          "table"
        )
        assert.are_not.equal(
          type(engine.allRequirements["Component2"]),
          "table"
        )
    ...
    it(
      ":addSystem() doesn`t add Systems to requirement lists multiple times",
      function()
        engine:addSystem(bothSystem, "draw")
        engine:addSystem(bothSystem, "update")
        ...
        assert.are.equal(engine.singleRequirements["Component1"][1], bothSystem)
        assert.are_not.equal(
          engine.singleRequirements["Component1"][2],
          bothSystem
        )
        assert.are_not.equal(
          type(engine.singleRequirements["Component2"]),
        ...
        assert.are.equal(engine.allRequirements["Component2"][1], bothSystem)
        assert.are_not.equal(
          engine.allRequirements["Component1"][2],
          bothSystem
        )
        assert.are_not.equal(
          engine.allRequirements["Component2"][2],
          bothSystem
        )
      end
    )
    ...
    it(
      ":addSystem() doesn`t add Systems to system lists multiple times",
      function()
        engine:addSystem(bothSystem, "draw")
        engine:addSystem(bothSystem, "draw")
    ...
    it(
      "Calling system status functions on not existing systems throws debug message.",
      function()
    ...
    it(
      "calls UpdateSystem:onComponentAdded when a component is added to UpdateSystem",
      function()
    ...
    it(
      "refuses to add two instances of the same system",
      function()
        local debug_spy = spy.on(lovetoys, "debug")
