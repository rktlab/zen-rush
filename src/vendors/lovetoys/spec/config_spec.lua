...
describe(
  ...
  function()
    ...
    it(
      "injects classes into the global namespace if globals = true is passed",
      function()
        local env = {}
        setmetatable(
          _G,
    ...
    it(
      "doesnt modify the global table by default",
      function()
        local lovetoys = require("")
        lovetoys.initialize({})
    ...
    it(
      "Allows to load via the old lovetoys module but prints a deprecation notice",
      function()
        stub(_G, "print")
