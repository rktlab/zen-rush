  ...
  function()
    ...
    it(
      ...
      function()
        ...
        assert.are.equal(
          entity.components[testComponent.class.name],
          testComponent
        )
      end
    )
    ...
    it(
      ":add() doesn`t add the same Component twice",
      function()
        ...
        assert.are_not.equal(
          entity.components[testComponent.class.name].int,
          13
        )
      end
    )
    ...
    it(
      ":remove() prints debug message if Component does not exist",
      function()
    ...
    it(
      ":getComponents() gets all components of an entity",
      function()
        entity:add(testComponent)
    ...
    it(
      ":has() shows if it has a Component",
      function()
        entity:add(testComponent)
    ...
    it(
      ":set() adds and overwrites Components",
      function()
        testComponent.int = 12
    ...
    it(
      ":addMultiple() adds Multiple Components at once",
      function()
        local componentList = {testComponent1, testComponent2, testComponent3}
        entity:addMultiple(componentList)
        assert.are.equal(
          entity.components[testComponent1.class.name],
          testComponent1
        )
        assert.are.equal(
          entity.components[testComponent2.class.name],
          testComponent2
        )
        assert.are.equal(
          entity.components[testComponent3.class.name],
          testComponent3
        )
      end
    )
    ...
    it(
      "Constructor with parrent adds a Parent",
      function()
    ...
    it(
      ":registerAsChild() registers as a Child",
      function()
        entity:setParent(parent)
