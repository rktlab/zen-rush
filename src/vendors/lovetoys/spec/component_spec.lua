...
describe(
  ...
  function()
    it(
      ":create with defaults creates a Component with default values",
      function()
        local c =
          lovetoys.Component.create(
          "TestComponent",
    ...
    it(
      ":load returns the specified components",
      function()
        ...
        local loaded1, loaded2, loaded3 =
          lovetoys.Component.load(
          {
            "TestComponent1",
            "TestComponent2",
            "TestComponent3"
